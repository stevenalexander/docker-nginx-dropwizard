...
curl -sLo linux-init https://github.com/stevenalexander/docker-nginx-dropwizard/raw/master/linux-init
curl -sLo run https://github.com/stevenalexander/docker-nginx-dropwizard/raw/master/run
